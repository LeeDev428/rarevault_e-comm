        ...
        <div class="left-section">
          ...
          <div class="user-profile-section">
            ...
            <div class="user-info">
              ...
              <p class="listing-type">Listing to marketplace</p>
            </div>
          </div>
  ...
  methods: {
    ...
    submitProduct() {
      ...
      this.confirmation = {
        ...
        message: 'Are you sure you want to publish this product? It will be visible to all buyers.',
        confirmText: 'Publish',
        cancelText: 'Cancel',
    ...
    async confirmSubmit() {
      ...
      try {
        ...
        // Here you would make the actual API call to create the product
        const productData = {
          ...this.productForm,
        ...
        this.showToast('Product published successfully!', 'success', 'Success')
        ...
        this.showToast('Failed to publish product. Please try again.', 'error', 'Error')
      } finally {
