    ...
    <div class="marketplace-container">
      ...
      <aside class="filter-sidebar">
        <div class="filter-section">
          ...
          <div class="filter-group">
            <label class="filter-item">
              <input type="checkbox" v-model="filters.categories" value="furniture">
              <span>Furniture</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.categories" value="decorative">
              <span>Decorative Arts</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.categories" value="jewelry">
              <span>Jewelry</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.categories" value="ceramics">
        ...
        <div class="filter-section">
          ...
          <div class="filter-group">
            <label class="filter-item">
              <input type="checkbox" v-model="filters.condition" value="pristine">
              <span>Pristine</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.condition" value="excellent">
              <span>Excellent</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.condition" value="good">
              <span>Good</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.condition" value="fair">
              <span>Fair</span>
            </label>
          </div>
        </div>
        ...
        <div class="filter-section">
          ...
          <div class="filter-group">
            <label class="filter-item">
              <input type="checkbox" v-model="filters.era" value="victorian">
              <span>Victorian (1837-1901)</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.era" value="edwardian">
              <span>Edwardian (1901-1910)</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.era" value="artdeco">
              <span>Art Deco (1920s-1930s)</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.era" value="midcentury">
              <span>Mid-Century (1940s-1960s)</span>
            </label>
          </div>
        </div>
      </aside>
...
export default {
  ...
  data() {
    return {
      ...
      items: [
        ...
        {
          id: 3,
          title: "Ming Dynasty Style Vase",
          price: 899.00,
          image: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=300&h=300&fit=crop",
          seller: "CeramicsExpert",
          category: "ceramics",
          condition: "good",
          era: "midcentury"
        }
  ...
  methods: {
    ...
    loadMoreItems() {
      console.log('Loading more antiques...')
    }
  }
}
</script>
