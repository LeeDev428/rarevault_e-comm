    ...
    <div class="marketplace-container">
      ...
      <aside class="filter-sidebar">
        <div class="filter-section">
          ...
          <div class="filter-group">
            <label class="filter-item">
              <input type="checkbox" v-model="filters.categories" value="books">
              <span>Rare Books</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.categories" value="art">
              <span>Vintage Art</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.categories" value="music">
              <span>Music Instruments</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.categories" value="textiles">
              <span>Vintage Textiles</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.categories" value="misc">
        ...
        <div class="filter-section">
          ...
          <div class="filter-group">
            <label class="filter-item">
              <input type="checkbox" v-model="filters.condition" value="mint">
              <span>Mint</span>
            </label>
            <label class="filter-item">
        ...
        <div class="filter-section">
          ...
          <div class="filter-group">
            <label class="filter-item">
              <input type="checkbox" v-model="filters.era" value="pre1900">
              <span>Pre-1900</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.era" value="1900s">
              <span>1900-1950</span>
            </label>
            <label class="filter-item">
              <input type="checkbox" v-model="filters.era" value="1950s">
              <span>1950-1980</span>
            </label>
            <label class="filter-item">
  ...
  data() {
    return {
      ...
      items: [
        {
          id: 1,
          title: "First Edition Hemingway Novel",
          price: 1899.99,
