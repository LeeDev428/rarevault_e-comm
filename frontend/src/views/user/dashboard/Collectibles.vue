  ...
  <UserLayout>
    <div class="marketplace-container">
      ...
      <div class="marketplace-header">
        <h1 class="page-title">Collectibles Marketplace</h1>
        <p>Find unique collectibles and memorabilia from verified sellers</p>
      </div>
    ...
    async fetchMarketplaceItems(isLoadMore = false) {
      try {
        ...
        const params = new URLSearchParams({
          ...
          per_page: 20,
          sort_by: this.sortBy,
          category: 'collectibles' // Filter specifically for collectibles
        });
